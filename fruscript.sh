...
version=" LTechKorea FRU Editor v1.0.3 (2022. 05. 24.)"
...
'
# http://patorjk.com/software/taag/#p=display&f=ANSI%20Shadow&t=LTechKorea%2C%20Inc%0AFRU%20Editor%20v1.0.3
echo "$version"
...
function Editor()
{
    ...
    do
        if [ $result = "y" ]; then
            echo -n -e "--------------------------------------------\n"
            echo -n -e " Insert Board Serial number (n = keep) : "
            read BS
            echo -n -e "\n Insert Product Serial number : "
            read PS 
            echo -n -e "--------------------------------------------\n"
            echo -n -e " Board Serial Number : $BS\n"
            echo -n -e " Product Serial Number : $PS\n"
            echo -n -e "--------------------------------------------\n"
...
for((;;))
do
    echo -n -e "▶ 1. Check FRU Information.\n"
    echo -n -e "▶ 2. Input FRU Information.\n"
    echo -n -e "▶ 3. Exit.\n"
    echo -n -e "--------------------------------------------\n : "
    read a
    if [ $a = "1" ]; then
